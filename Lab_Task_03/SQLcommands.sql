...
--G
SELECT CUSTOMER_NAME, CUSTOMER_CITY FROM DEPOSITOR_INFO,CUSTOMER,ACCOUNT WHERE DEPOSITOR_INFO.C_NO = CUSTOMER.CUSTOMER_NO AND DEPOSITOR_INFO.A_NO = ACCOUNT.ACCOUNT_NO;
--H
SELECT CUSTOMER_NO,CUSTOMER_NAME, CUSTOMER_CITY FROM CUSTOMER,ACCOUNT,DEPOSITOR_INFO WHERE DEPOSITOR_INFO.A_NO = ACCOUNT.ACCOUNT_NO AND DEPOSITOR_INFO.C_NO = CUSTOMER.CUSTOMER_NO AND ACCOUNT.BALANCE > 1000;
--I
SELECT DISTINCT ACCOUNT_NO,BALANCE FROM CUSTOMER,ACCOUNT,DEPOSITOR_INFO WHERE DEPOSITOR_INFO.A_NO = ACCOUNT.ACCOUNT_NO AND DEPOSITOR_INFO.C_NO = CUSTOMER.CUSTOMER_NO AND CUSTOMER.CUSTOMER_CITY = 'DHK' OR ACCOUNT.BALANCE BETWEEN 5000 AND 10000;
